...
from audio_flow.models.aligner_ljspeech_04b2 import Aligner_ljspeech_04b2
from audio_flow.utils import get_single_value


class Adapter_ljspeech_04b2(nn.Module): 
    def __init__(self, dim: int, max_length: int, **kwargs):
        ...
        self.char_aligner = Aligner_ljspeech_04b2(dim, dim, max_length)
